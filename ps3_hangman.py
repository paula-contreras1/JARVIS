...
def hangman(secretWord):
    ...
    * After each round, you should also display to the user the 
    ...
    print("I am thinking of a word that is " + str(lenSecret) + " letters long")
    print(linebreak)
    lettersGuessed = []
    numGuesses = 8
    while numGuesses > 0:
        ...
        if lowerGuess in lettersGuessed:
            ...
            if lowerGuess in secretWord:
                ...
                print(linebreak)
        allGuesses = str(getGuessedWord(secretWord, lettersGuessed))
        if allGuesses == secretWord:
            break
    if allGuesses == secretWord:
